...
const Card = ({ title, image, color, onPress }: { title: string; image: any; color: any; onPress?: () => void }) => {
  return (
    <TouchableOpacity onPress={onPress} className={`${color} bg-white shadow-md rounded-lg overflow-hidden my-2 border border-black`}>
